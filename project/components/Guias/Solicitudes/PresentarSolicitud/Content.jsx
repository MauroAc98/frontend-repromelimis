...
export const Content = (props) => {
  ...
  const handleClickConfirmar = async () => {
    ...
    try {
      ...
      const url = `/solicitudes-guias/presentar-solicitud/${props.solicitudData.id}`;
      /*props.solicitudGuia.tipo_tramite == "INSCRIPCION"
        ? `/solicitudes-guias/presentar-solicitud/${props.solicitudGuia.id}`
        : `/solicitudes-guias/presentar-actualizacion/${props.solicitudGuia.id}`;*/
